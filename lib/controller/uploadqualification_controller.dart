...
class UploadQualificationImageeController extends GetxController{
  ...
  void getImage(ImageSource imageSource,BuildContext context) async {
    ...
    if(pickedFile!=null) {
      ...
      await Provider.of<ProfileRepo>(context,listen: false).uploadQualificationImageeApi(base64Image);
