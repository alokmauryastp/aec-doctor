...
class _EditMedicinePageState extends State<EditMedicinePage> {
  ...
  late Datum medicinelist;


  void initalizeDataToAllTextField(){
    setState((){
      name.text=medicinelist.name;
     genericName.text=medicinelist.generic;
      strength.text=medicinelist.strength;
     dosage.text=medicinelist.dosage;
      duration.text=medicinelist.duration;
      comments.text=medicinelist.comment;
    });
  }

  @override
  void initState() {
    medicinelist=Get.arguments;
  ...
  Widget build(BuildContext context) {
    ...
    Map parameter={
      'doctor_id':doctorId,
      "medicine_id": medicinelist.medicineId,
    'name':name.text,
    ...
    TemplateRep().editMedicine(parameter).then((value) {
    setState((){
    loading=false;
    });
    if(value['status']==1){
