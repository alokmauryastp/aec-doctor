...
class AddAdvicePage extends StatefulWidget {
  const AddAdvicePage({Key? key}) : super(key: key);

  @override
  _AddAdvicePageState createState() => _AddAdvicePageState();
}
            ...
            child: Padding(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    Text("Add Advice",style: StringsStyle.title,),
                    SizedBox(height:10),
                    TextFormField(
                        ...
                        Bounce(
                          ...
                          onPressed: ()async {
                            if (_formKey.currentState!.validate()) {
                              ...
                              TemplateRep().addAdvice(parameter).then((value) {
                                setState((){
                                  loading=false;
                                });
                                if(value['status']==1){
