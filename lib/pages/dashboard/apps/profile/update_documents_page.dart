...
class UpdateDocumentPage extends StatefulWidget {
  const UpdateDocumentPage({Key? key}) : super(key: key);
  ...
  void initState() {
    WidgetsBinding.instance!.addPostFrameCallback((timeStamp) {
      timer = new Timer.periodic(new Duration(seconds: 1), (Timer timer) async {
        status = await SharedPrefManager.getPrefrenceString(AppConstant.STATUS);
      });
    });
    _allDetail();
    super.initState();
            ...
            child: Row(
              ...
              children: [
                ...
                InkWell(
                    // onTap: ()async{
                    //  setState(() async{
                    //    await showPicker(context,status);
                    //    print("ydjdkauiss"+status);
                    //  });
                    //    },
                    child: status=="1"?Icon(Icons.done,size: 25,color: AppColors.appbarbackgroundColor,):
                    Icon(Icons.done,size: 25,color: AppColors.appbarbackgroundColor,))
              ],
            ),
          ),
          // child: TextFormField(
          ...
          child: Row(
            ...
            children: [
              ...
              InkWell(
                  ...
                  child: Icon(Icons.done,size: 25,color: AppColors.appbarbackgroundColor,)),
            ],
          ),
        ),
        // child: TextFormField(
...
showPicker(context,String status) {
              ...
              children: <Widget>[
                ...
                new ListTile(
                  ...
                  onTap: () async{
                   ...
                   String statuss = await SharedPrefManager.getPrefrenceString(AppConstant.STATUSFRONTPHOTO);
                   print("ydjdkaui"+statuss);
                    Navigator.of(context).pop();
                  },
                ),
              ],
