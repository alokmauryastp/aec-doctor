// @dart=2.9
class OldPatientsModel {
  int status;
  String msg;
  List<OldPatientsData> data;

  OldPatientsModel({this.status, this.msg, this.data});

  OldPatientsModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    msg = json['msg'];
    if (json['data'] != null) {
      data = new List<OldPatientsData>();
      json['data'].forEach((v) {
        data.add(new OldPatientsData.fromJson(v));
      });
    }
  }
...
class OldPatientsData {
  ...
  OldPatientsData.fromJson(Map<String, dynamic> json) {
