// @dart=2.9
class UpcomingPatientModel {
  int status;
  String msg;
  List<UpcomingPatientData> data;

  UpcomingPatientModel({this.status, this.msg, this.data});

  UpcomingPatientModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    msg = json['msg'];
    if (json['data'] != null) {
      data = new List<UpcomingPatientData>();
      json['data'].forEach((v) {
        data.add(new UpcomingPatientData.fromJson(v));
      });
    }
  }
...
class UpcomingPatientData {
  ...
  UpcomingPatientData.fromJson(Map<String, dynamic> json) {
