// @dart = 2.9
class CancelledPatientModel {
  int status;
  String msg;
  List<CancelledPatientData> data;

  CancelledPatientModel({this.status, this.msg, this.data});

  CancelledPatientModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    msg = json['msg'];
    if (json['data'] != null) {
      data = new List<CancelledPatientData>();
      json['data'].forEach((v) {
        data.add(new CancelledPatientData.fromJson(v));
      });
    }
  }
...
class CancelledPatientData {
  ...
  CancelledPatientData.fromJson(Map<String, dynamic> json) {
