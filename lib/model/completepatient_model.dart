// @dart=2.9
class CompletePatientModel {
  int status;
  String msg;
  List<CompletePatientData> data;

  CompletePatientModel({this.status, this.msg, this.data});

  CompletePatientModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    msg = json['msg'];
    if (json['data'] != null) {
      data = new List<CompletePatientData>();
      json['data'].forEach((v) {
        data.add(new CompletePatientData.fromJson(v));
      });
    }
  }
...
class CompletePatientData {
  ...
  CompletePatientData.fromJson(Map<String, dynamic> json) {
